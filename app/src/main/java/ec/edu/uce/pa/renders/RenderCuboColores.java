...
public class RenderCuboColores implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if(MainActivity.rotar){
            gl.glRotatef(MainActivity.iRotacion, MainActivity.rotarX, MainActivity.rotarY, MainActivity.rotarZ);
            prisma.dibujar(gl);
